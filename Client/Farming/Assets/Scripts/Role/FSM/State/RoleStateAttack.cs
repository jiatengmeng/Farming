...
public class RoleStateAttack : RoleStateAbstract
{
    ...
    {
        base.OnEnter();
        CurRoleFSMMgr.CurRoleCtrl.Animator.SetBool(ToAnimatorCondition.ToAttack.ToString(), true);
    }
    ...
    public override void OnUpdate()
    {
        ...
        if(CurRoleAnimatorStateInfo.IsName(RoleAnimatorName.Attack.ToString()))
        {
    ...
    {
        base.OnExit();
        CurRoleFSMMgr.CurRoleCtrl.Animator.SetBool(ToAnimatorCondition.ToAttack.ToString(), false);
    }
}
